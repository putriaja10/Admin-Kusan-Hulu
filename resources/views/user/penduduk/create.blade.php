<x-layout>
    ...
    <div>
        <x-form.form-layout action="{{ route('user.penduduk.store') }}">
            
            <div>
                <x-form.form-label for="desa_name">
                    Desa
                </x-form.form-label>
                <x-form.form-input
                    type="text"
                    ...
                    placeholder="Desa"
                    required />
                <x-form.form-error errorFor="desa_name" />
            </div>

            
            <div>
                <x-form.form-label for="no_kartu_keluarga">
                    No. Kartu Keluarga
                </x-form.form-label>
                <x-form.form-input
                    type="text"
                    ...
                    required />
                <x-form.form-error errorFor="no_kartu_keluarga" />
            </div>
